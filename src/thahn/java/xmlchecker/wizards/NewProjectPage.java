...
public class NewProjectPage extends WizardPage implements ModifyListener, SelectionListener, FocusListener {
	...
	NewProjectPage() {
		...
		setTitle("New CMS Descriptor Project");
		setDescription("Creates a new CMS Descriptor Project");
	}
	...
	public void createControl(Composite parent) {
		...
		mApplicationDec = createFieldDecoration(mProjectText,
				"The project name is shown in project explorer, as well as in the Eclipse.");
